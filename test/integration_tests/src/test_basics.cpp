...
BOOST_AUTO_TEST_CASE(column_name)
{
  ...
  cass_result_column_name(result.get(), 1, &v2.data, &v2.length);
  cass_result_column_name(result.get(), 1, &v3.data, &v3.length);
  cass_result_column_name(result.get(), 1, &v4.data, &v4.length);
